...
if __name__ == '__main__':
    ...
    expt_name = "Ningaloo_wombatlite_sd_2year" 
    ...
    # In this current set up, manually setting the time for data is needed as the data  ( pulled under setup_unprocesses) from the 0.25 RYF gloabl run is a for an earlier year that wont work with the JRA-55 forcing. 
    time = pd.date_range(start=date_range[0], end=date_range[1], freq='MS') + pd.offsets.Day(14)
    ...
    if setup_unprocessed:
        ...
        buffer=0.6
        wombatlitepath='/g/data/ol01/ee8016/regional_wombat/OM3_25km_jra_ryf+wombatlite/'
        var3d=['alk','fe','no3','o2','phy', 'zoo', 'det', 'caco3', 'pchl', 'phyfe', 'zoofe', 'detfe', 'dic','dicp', 'dicr','so','thetao','uo','vo']
        
        var2d=['SSH','det_sediment','caco3_sediment','detfe_sediment']
    ...
    if setup_regridded:
       ...
       #changing fillvalue
        ...
        ds.to_netcdf(input_dir+'obgc_obc.nc', unlimited_dims='time',encoding=encoding)
            
    #I am not actually sure this gets used in the model run
